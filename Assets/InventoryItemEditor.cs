...
public class InventoryItemEditor : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        if (inventoryItemList != null)
        {
            ...
            if (inventoryItemList.itemList.Count > 0)
            {
                ...
                inventoryItemList.itemList[viewIndex - 1].itemName = (Equipments)EditorGUILayout.EnumPopup("ItemName", inventoryItemList.itemList[viewIndex - 1].itemName);
                ...
                GUILayout.BeginHorizontal();
                inventoryItemList.itemList[viewIndex - 1].usesAmmo = (bool)EditorGUILayout.Toggle("usesAmmo", inventoryItemList.itemList[viewIndex - 1].usesAmmo, GUILayout.ExpandWidth(false));
                GUILayout.EndHorizontal();
    ...
    void AddItem()
    {
        ...
        newItem.itemName = Equipments.None;
